...
public enum Gen {
    ...
    public static List<String> toSpinnerList (Context context){
        ...
        // in spinner
        for (Gen g : Gen.values()) {
            String enumResString = DataUtils.getStringFromEnumName(g, context);
    ...
    public static Gen fromSpinnerSelection(Context context, String spinnerSelectionValue) {
