...
public enum TesteAnaliza {
    ...
    public static List<String> toSpinnerList (Context context){
        ...
        // in spinner
        for (TesteAnaliza t : TesteAnaliza.values()) {
    ...
    public static TesteAnaliza fromSpinnerSelection(Context context, String spinnerSelectionValue) {
