...
public enum TipCadreMedicale {
    ...
    public static List<String> toSpinnerList (Context context){
        ...
        // in spinner
        for (TipCadreMedicale t : TipCadreMedicale.values()) {
    ...
    public static TipCadreMedicale fromSpinnerSelection(Context context, String spinnerSelectionValue) {
        ...
        return TipCadreMedicale.Asistent;
    }
}
